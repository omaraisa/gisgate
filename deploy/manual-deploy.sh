#!/bin/bash
# Manual deployment script for GIS Gate
# This can be run directly on the server to redeploy current code
# Usage: ssh root@204.12.205.110 "/opt/apps/gisgate/manual-deploy.sh"
